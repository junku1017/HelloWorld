...
public class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	public static void picture(double x, double y, String s) {
		...
		double xs = scaleX(x);
		double ys = scaleY(y);
		int ws = 10;//image.getWidth(null);
		int hs = 10;//image.getHeight(null);
	...
	static int [][] a2=new int [30][30];
	public static void paint(){
		for(int i =0; i<a2.length; i++){
			for (int j=0; j<a2.length; j++){	
				double a=(i-a2.length/2)/((double)(a2.length/2));
				double b=(j-a2.length/2)/((double)(a2.length/2));
				if(a2[i][j]==1 ){
					StdDraw.filledCircle(a, b, 1.0/a2.length); 
				}
				if(a2[i][j]==2 ){
					StdDraw.filledCircle(a, b, 1.0/a2.length); 
				}
	...
	public static boolean isconflict(int ix1,int ix2,int ix3,int ix4,int iy1,int iy2,int iy3,int iy4){
		if(iy1==0) return true;
		if(iy1==a2.length-1) return true;
		if(ix1==0) return true;
		if(ix1==a2.length-1) return true;
		if(a2[ix1][iy1]==2) return true;
		if(iy2==0) return true;
		if(iy2==a2.length-1) return true;
		if(ix2==0) return true;
		if(ix2==a2.length-1) return true;
		if(a2[ix2][iy2]==2) return true;
		if(iy3==0) return true;
		if(iy3==a2.length-1) return true;
		if(ix3==0)return true;
		if(ix3==a2.length-1)
			return true;
		if(a2[ix3][iy3]==2)
			return true;
	...
	public static int blockType = 1; //1-7
	public static int blockOrientation = 1; //1:up, 2: right, 3:left, 4:down
	...
	public static void move(int direction){
		if (direction == up){
			...
			if(blockType == 1){
				...
				System.out.println("is conflict:"+isconflict(ix1+1, ix2+1, ix3+1, ix4+1, iy1, iy2, iy3, iy4));
				if(!isconflict(ix1+1, ix2+1, ix3+1, ix4+1, iy1, iy2, iy3, iy4)){
					a2[ix1][iy1] = 0;
					a2[ix2][iy2] = 0;
					a2[ix3][iy3] = 0;
					a2[ix4][iy4] = 0;
	 ...
	 * Test client.
	 */
	public static int ix1;
	public static int iy1;
	public static int ix2;
	public static int iy2;
	public static int ix3;
	public static int iy3;
	public static int ix4;
	public static int iy4;
	static double rx = 0, ry = 0.94;     // position
